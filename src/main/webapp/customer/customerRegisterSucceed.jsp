...
<head>
    ...
    <meta http-equiv="refresh" content="3; url=customerBasic.jsp">
...
<body>
    ...
    <main class="main_height">
        <div class="page_container_short">
            <span class="re-register_span">帳戶啟用成功！<br>將於3秒後跳轉至食健首頁</span>
        </div>
    </main>
	...
	<%-- <script>
		const server = '<%=request.getServerName()+":"+request.getServerPort()+request.getContextPath()%>';
	</script> --%>
    <script defer src="https://use.fontawesome.com/releases/v5.0.0/js/all.js"></script>

 <%--    <script src="<%=request.getContextPath()%>/customer/js/forward.js"></script> --%>
