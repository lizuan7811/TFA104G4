...
<body>
    ...
    <main class="main_height">
        <div class="page_container_pre_register">
            <h2 class="title">會員註冊</h2>
            <div>
                <div>
                    <button type="button" id="google_login_btn" class="third_party_login_btn" value="google_regis">
                        ...
                        <span class="third_party_login_span">用Google帳號註冊</span>
                    </button>
                </div>

                <div class="fb_login">
                    <button type="button" id="fb_login_btn" class="third_party_login_btn" value="fb_regis">
                        <span class="base_iconWrapper__3k0lf">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                ...
                                <path
                                    ...
                                    fill="white"></path>
                                <defs>
                                    <linearGradient id="paint0_linear" x1="8" y1="0" x2="8" y2="15.9525"
                        ...
                        <span class="third_party_login_span">用Facebook帳號註冊</span>
                    </button>
                </div>

                <div class="apple_login">
                    <button type="button" id="apple_login_btn" class="third_party_login_btn" value="apple_regis">
                        <span class="base_iconWrapper__3k0lf">
                        ...
                        <span class="third_party_login_span">用Apple帳號註冊</span>
                    </button>
                </div>
            </div>
            <a href="customerRegister.jsp" id="self_register_btn">以電子信箱登入或註冊新帳號</a>
            <br>
            <br>
            <h6 id="register_policy">註冊即表示你同意並接受我們的 條款細則 及 隱私權政策 。</h6>
        </div>
