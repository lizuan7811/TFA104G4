...
<body>
    ...
    <main class="main_height">
        <div class="page_container_short">
            ...
            <span>請輸入您的Email，我們將發送重設密碼連結</span>
            ...
            <form action="<%=request.getContextPath() %>/customerCustomerServlet" method="post" class="form_content">
                <input type="email" name="email" class="input_text" placeholder="Email" autofocus
                    autocomplete="true">
                 <input type="hidden" name="action" value="forget">
                <input type="submit" class="submit_btn" value="重設密碼">
            </form>
        </div>
    </main>
