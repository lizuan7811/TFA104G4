...
<header>
        ...
        <div class="icon">
            ...
            <!-- 加入購物車 icon -->
            <div class="cart_icon"><i class="fas fa-shopping-cart"></i><span class="cart-counter">0</span></div> 
...
<form name="shoppingForm" action="<%=request.getContextPath()%>/CartServlet" method="POST">
        <div class="inner">
            <div class="product_img">
                <img src="<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/雞胸肉.jpg">
            </div>
            <div class="box1">
            ...
            <div class="box3">
                <div class="shopBar"></div>
                    ...
                    <span style="margin: 10px 10px;"><input id="inputvalue" type="text" class="product_input" name="quantity" value="1"></span>
                    <span class="plus"><i class="fas fa-plus-square"></i></span>
                   <!-- <i class="fas fa-shopping-cart"></i>放入購物車</span> --> <span >
                    <input class="buy_icon" type="submit" name="Submit" value="放入購物車">
            ...
            <div class="backShop_icon" onclick="location.href='shop.html#sort1'">
