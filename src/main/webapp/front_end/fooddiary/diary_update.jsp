        ...
        <form action="<%=request.getContextPath() %>/FoodDiaryServlet" name="form1" enctype="multipart/form-data"  method="post">
                <div class="add_content"><br>
                    <div>
                        ...
                        <span class="info">請選擇文章類型:  </span>
                        <select class="select_type" name="diary_type">
                    ...
                    <input class="article_title" type="text" name="subject" placeholder="請輸入文章標題"value="<%= diaryVO.getSubject() %>"/>
                    ...
                    <textarea class="text" name="text" placeholder="請輸入文章內容..."><%= diaryVO.getText() %></textarea>
                        ...
                        <div class="all_btn">
                            ...
                            <input type="hidden" name="diaryid" value="<%= diaryVO.getDiaryID() %>">
                            <input class="submit_article" type="submit" value="送出修改" name="add_article" >
                        </div>
...
<script type="text/javascript">
    	$(".select_type").val(<%= diaryVO.getDiaryType() %>);
</script>
</html>