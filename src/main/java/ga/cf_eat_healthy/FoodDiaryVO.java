...
public class FoodDiaryVO implements Serializable{
	...
	public FoodDiaryVO(Integer diaryID, Integer custID, String subject, String text, Timestamp createdTime,
			Byte pooto_video_1, Byte pooto_video_2, Byte pooto_video_3, Boolean status, Integer forumLikeNum,
		...
		this.photo_video_1 = pooto_video_1;
		this.photo_video_2 = pooto_video_2;
		this.photo_video_3 = pooto_video_3;
		this.status = status;
	...
	public void setPhoto_video_1(Byte photo_video_1) {
	...
	public void setPhoto_video_2(Byte photo_video_2) {
